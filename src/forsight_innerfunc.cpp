...
bool call_fkj_one  (eval_value *result, const char * valFirst,const char * valSecond,const char * valThird, const char * valFourth, const char * valFiveth);
bool call_fkj_two  (eval_value *result, const char * valFirst,const char * valSecond,const char * valThird, const char * valFourth, const char * valFiveth);
...
// 	(char *)"gcvt",      1, call_gcvt ,
    (char *)FUNC_FKJ_ONE,   0, call_fkj_one ,
    (char *)FUNC_FKJ_TWO,   0, call_fkj_two ,
    (char *)"",             0, 0 , 
};
...
{   
    ...
    if(index >= 0)
	{
		...
		{
			(*intern_func[index].p)(result, valFirst, valSecond, valThird, valFourth, valFiveth);
			return true;
		}
	}
	return false ;
