...
int main(int argc, char **argv)
{
	...
	if((strcmp("all", cCase) == 0) || (strcmp("pr", cCase) == 0))
	{
		test_pr_calculation();
	}
 	if((strcmp("all", cCase) == 0) || (strcmp("r", cCase) == 0))
	{
		test_r_calculation();
	}
	if((strcmp("all", cCase) == 0) || (strcmp("mr", cCase) == 0))
	{
		test_mr_calculation();
	}
